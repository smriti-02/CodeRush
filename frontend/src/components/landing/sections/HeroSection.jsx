  ...
  return (
    <section id="hero" className="relative h-screen w-full flex flex-col overflow-hidden z-10">
      <nav className="w-full max-w-7xl mx-auto px-6 py-6 flex justify-between items-center z-50 relative pointer-events-auto">
        <a href="/" className="text-2xl font-bold tracking-tighter text-[#39d353] hover:text-white transition-colors cursor-pointer">
          &lt;CODERUSH/&gt;
        </a>
      ...
      <main className="relative flex-1 w-full max-w-7xl mx-auto px-6 flex flex-col justify-center pointer-events-none">
        <div className="max-w-3xl pointer-events-auto">
          ...
          <h1 className="text-[120px] md:text-[140px] leading-[0.85] font-black tracking-tighter uppercase mb-4">
            <span className="block text-white drop-shadow-2xl">BATTLE</span>
            <span className="block text-white drop-shadow-2xl">YOUR WAY</span>
            <span className="block text-[#39d353] text-[90px] md:text-[110px] leading-[0.8] mt-4 font-light tracking-tight capitalize shadow-green-glow">
              To Glory
            </span>
          </h1>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center text-gray-500 text-[10px] font-bold tracking-widest uppercase animate-bounce pointer-events-none">
